    ...
    actions: {
        async fetchProducts({ commit }) {
            try {
                ...
                console.log('Fetched products:', res.data); // Kiểm tra dữ liệu
        ...
        async fetchProductSizes({ commit }) {
            try {
                ...
                console.log('Fetched product_sizes:', res.data); // Kiểm tra dữ liệu
                commit('setProductSizes', res.data);
            } catch (err) {
                console.error('Lỗi fetchProductSizes:', err);
            }
        },
        ...
        async fetchCategories({ commit }) {
            try {
                ...
                console.log('Fetched categories:', res.data); // Kiểm tra dữ liệu
